...
export default function SecurityCamerasPage() {
    ...
    const whyChooseUs = [
        ...
        },
        {
            ...
            description: "Encrypted connections, user access controls, and local recording for privacy",
            color: "text-blue-600"
        },
        {
            icon: Clock,
        ...
        },
        {
            ...
            description: "We match the cameras to your property — not oversell or undersell",
