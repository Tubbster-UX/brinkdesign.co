...
export default function LogoCloud() {
    return (
        <section className="py-16 border-t mt-16 bg-gray-400">
            <div className="max-w-6xl mx-auto px-6 text-center">
                <p className="text-sm font-bold uppercase tracking-wider mb-6">Brands We Work With</p>
                <div className="flex flex-wrap justify-center items-center gap-8">
                    {logos.map((logo, index) => (
                        ...
                        >
                            <div className="relative overflow-hidden rounded-lg p-3 transition-transform duration-300 ease-in-out group-hover:scale-110 group-hover:bg-white/5">
                                <Image 
                                    src={logo.src} 
                                    alt={logo.alt} 
                                    width={100}
